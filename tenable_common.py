...
class CriblHECHandler:
    ...
    def __init__(self, host, port, token, index, sourcetype, source, ssl_verify=True):
        """
    ...
    def send_event(self, event_data, timestamp=None, sourcetype=None, source=None):
        """
    ...
    def send_batch(self, events, sourcetype=None):
        ...
        try:
            ...
            logging.debug("Flushed batch of {0} events to Cribl".format(success_count))
        except Exception as e:
